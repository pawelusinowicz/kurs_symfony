...
class MyAuctionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $auctions=$entityManager->getRepository(Auction::class)
    ...
    {
        //if($this->getUser() instanceof User) pierwszy sposob spr czy jestes zalogowany

//        if($this->isGranted("ROLE_USER")) drugi sposob
//        {
//
//        }

        $this->denyAccessUnlessGranted("ROLE_USER"); // trzeci sposob, najlepszy
        ...
        if($request->isMethod("post")){
            ...
            if($auction->getStartingPrice()>=$auction->getPrice()) {
                $form
                    ->get("startingPrice")
                    ->addError(new FormError("Cena wywoławcza nie może być wyższa od ceny kup teraz"));
            }
